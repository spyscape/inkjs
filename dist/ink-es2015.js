(function (global, factory) {
	...
	(global = global || self, factory(global.inkjs = {}));
	...
	class StringBuilder {
	    ...
	    AppendFormat(format, ...args) {
	        ...
	        this.string += format.replace(/{(\d+)}/g, (match, num) => {
	...
	function tryParseInt(value, /* out */ defaultValue = 0) {
	...
	function tryParseFloat(value, /* out */ defaultValue = 0) {
	...
	class NativeFunctionCall extends InkObject {
	    ...
	    static GenerateNativeFunctionsIfNecessary() {
	        if (this._nativeFunctions == null) {
	            ...
	            let divertTargetsNotEqual = (d1, d2) => {
	    ...
	    ContinueSingleStep() {
	        ...
	        if (!this.state.inStringEvaluation) {
	            if (this._stateAtLastNewline != null) {
	                ...
	                let change = this.CalculateNewlineOutputStateChange(this._stateAtLastNewline.currentText, this.state.currentText, this._stateAtLastNewline.currentTags.length, this.state.currentTags.length);
